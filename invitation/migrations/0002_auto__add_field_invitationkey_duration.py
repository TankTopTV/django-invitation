...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InvitationKey.duration'
        db.add_column('invitation_invitationkey', 'duration',
                      self.gf('django.db.models.fields.IntegerField')(default=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InvitationKey.duration'
        db.delete_column('invitation_invitationkey', 'duration')
