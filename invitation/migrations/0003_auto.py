...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'InvitationKey', fields ['key']
        db.create_index('invitation_invitationkey', ['key'])


    def backwards(self, orm):
        # Removing index on 'InvitationKey', fields ['key']
        db.delete_index('invitation_invitationkey', ['key'])
    ...
    models = {
        ...
        'invitation.invitationkey': {
            ...
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '30', 'null': 'True'}),
